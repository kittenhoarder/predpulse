  ...
  return (
    <svg className="probability-landscape h-full w-full" viewBox="0 0 960 560" preserveAspectRatio="xMidYMid slice" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      ...
      <g className="landscape-curves" strokeLinejoin="round" strokeLinecap="round">
        <g className="landscape-layer landscape-layer-one">
        ...
        <g className="landscape-layer landscape-layer-two">
        ...
        <g className="landscape-layer landscape-layer-three">
        ...
        <g className="landscape-layer landscape-layer-focus">
        ...
        <g className="landscape-layer landscape-layer-accent">
